...
public class DetailView {
    ...
    public VBox viewStudent(String itemString) {
        try {
            ...
            // Student selectedStudent = new Student();//TODO: get student with parts[1]
            // (email)
            ...
            // Label adress = new Label("Adress: "+ selectedStudent.getZipCode()+"
            // "+selectedStudent.getStreet()+" "+selectedStudent.getHouseNumber());
