...
public class Student {
    ...
    public boolean vallidate(){
        ...
        if(email != null && zipCode != null) {
            if(email.matches("^[a-zA-Z]+@[a-zA-Z]+[.]{1}[a-zA-Z]+$") && zipCode.matches("^[1-9]{1}[0-9]{3} [A-Z]{2}$") && dateOfBirth == null | dateOfBirth.toString().matches("^\\d{4}-(0?[1-9]|1[012])-(0?[1-9]|[12][0-9]|3[01])$")){
                return true;
            } else{
                return false;
            }
